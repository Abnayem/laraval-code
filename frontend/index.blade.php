                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{url('assets/img/carousel-1.jpg')}}" style="object-fit: cover;">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{url('assets/img/carousel-2.jpg')}}" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{url('assets/img/carousel-3.jpg')}}" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
            ...
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-1.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-2.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-3.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-4.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-5.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-6.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-7.jpg')}}" alt="">
                    </div>
                    <div class="bg-light p-4">
                        <img src="{{url('assets/img/vendor-8.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
