 <!-- Footer Start -->
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-primary" href="#"></a>. All Rights Reserved. Create
                    by
                    <a class="text-primary" href="https://abnayem.info"> Abu Nayem</a>
                </p>
            </div>
    ...
    <script src="{{url('assets/assetsmail/contact.js')}}"></script>
