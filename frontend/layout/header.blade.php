                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                             @if(Auth::check())
                             <a href="{{url('/logout')}}" class="nav-item nav-link active">Log Out</a>
                             @else
                            <a href="{{url('/register')}}" class="nav-item nav-link active">Sign up</a>
                            <a href="{{url('/login')}}" class="nav-item nav-link active">Sign In</a>
                                @endif
